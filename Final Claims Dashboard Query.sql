...
WITH
    ...
    Claims_Data AS (
        WITH
            ...
            Claim_Level_Data as (
                SELECT
                    ...
                    case
                        ...
                        when lrd.cob_segments ='Construction' then 'Construction'
                        else 'All Other'
                    end as cob_grouping,
                    case
                    ...
                    lrd.ay_age, lrd.py_age, lrd.am_age, lrd.transaction_month::date, lrd.coverage,
                    ...
                    lrd.renewal_tag,
                    sum(paid_loss) as paid_loss, sum(incurred_loss) as reported_loss, sum(paid_dcce) as paid_dcce,
            ...
            Claim_Manipulation as (
                SELECT
                    ...
                    --- *** NEW METRICS ADDED HERE BASED ON YOUR LOGIC *** ---
        ...
        SELECT
            claim_number, transaction_month, lob, cob_name, cob_group, cob_grouping, channel, state, coverage, AY, PY, ay_age, py_age, am_age, loss_cause_type_name, paygo_indicator,
    ...
    Premium_Data AS (
        ...
        SELECT
            '' as claim_number, transaction_month, lob, cob_name, cob_group, cob_grouping, channel, state, coverage, AY, PY, ay_age, py_age, am_age,
...
SELECT
    u.claim_number, u.transaction_month, u.lob, u.cob_name, u.cob_group, u.cob_grouping, u.channel, u.state, u.coverage, u.AY, u.PY, u.ay_age, u.py_age, u.am_age,
